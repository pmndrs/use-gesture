...
import UseGesture from './docs/code/rug'
...
<HeroSection>
  <HeroBody style={{ width: '100%', textAlign: 'center', padding: '46px 0' }}>
    ...
    <HeroTeaser>
      <UseGesture />
      &nbsp;&nbsp;is the only gesture lib you'll need.
    </HeroTeaser>
  ...
  <FeatureList>
    <Feature col={{ xs: 1, md: 1 / 3 }}>
      ...
      <FeatureText style={{ textAlign: 'left' }}>
        <UseGesture /> allows you to implement advanced UI interactions with just a few lines of code.
      </FeatureText>
    </Feature>
    <Feature col={{ xs: 1, md: 1 / 3 }}>
    ...
    <Feature col={{ xs: 1, md: 1 / 3 }}>
      ...
      <FeatureText style={{ textAlign: 'left' }}>
        Any animation framework can work! <UseGesture pkg="react" /> operates nicely with both{' '}
