...
4. `useTouch` option for drag in case you want to not lose dragging while the window is scrolling on mobile [#237](https://github.com/pmndrs/react-use-gesture/issues/237).
