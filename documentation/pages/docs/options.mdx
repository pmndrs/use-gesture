...
| [`distanceBounds`](#bounds)                        | **pinch** | Limits the distance `movement` and `offset` to the specified bounds.                                                                                                                                 |
| [`angleBounds`](#bounds)                           | **pinch** | Limits the angle `movement` and `offset` to the specified bounds.                                                                                                                                    |
