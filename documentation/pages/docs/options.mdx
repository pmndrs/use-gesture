...
| [`pointer.touch`](#pointertouch-drag-and-pinch) | **drag,pinch** | If `true`, drag will use touch events on touch-enabled devices. [Read more below](#pointertouc-drag-and-pinch).                                                                                      |
