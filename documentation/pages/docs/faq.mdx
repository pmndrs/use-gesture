...
Have a look at [this sandbox](https://codesandbox.io/s/github/pmndrs/use-gesture/tree/v10/demo/src/sandboxes/draggable-image) for an example with dragging an image.
