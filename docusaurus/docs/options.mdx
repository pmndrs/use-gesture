...
| [_`initial`_](#initial)       |    `Array<[number`\|`fn]>`    |    `[0,0]`    | The initial position _`movement`_ should start from.                                                                                          |
...
> Unless your initial position is static or depends on React `state`, make sure you use _`initial`_ items are functions.
