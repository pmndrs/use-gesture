...
function visitFile(filePath, cwd, visitedFiles, predefinedImports) {
    ...
    if (!visitedFiles.has(filePath)) {
        ...
        var otherLines = '';
        try {
            for (var _q = tslib.__values(fileContent.split('\n')), _r = _q.next(); !_r.done; _r = _q.next()) {
                var line = _r.value;
        ...
        if (otherLines) {
            ...
            try {
                for (var _s = tslib.__values(document_1.definitions), _t = _s.next(); !_t.done; _t = _s.next()) {
                    ...
                    if ('name' in definition || definition.kind === graphql.Kind.SCHEMA_DEFINITION) {
                        ...
                        if ('fields' in definition && definition.fields) {
                            try {
                                for (var _u = (e_5 = void 0, tslib.__values(definition.fields)), _v = _u.next(); !_v.done; _v = _u.next()) {
                                    var field = _v.value;
                                    ...
                                    (_p = definitionsByName.get(definitionName_1)) === null || _p === void 0 ? void 0 : _p.add(tslib.__assign(tslib.__assign({}, definition), { fields: [field] }));
            ...
            try {
                for (var definitionsByName_1 = tslib.__values(definitionsByName), definitionsByName_1_1 = definitionsByName_1.next(); !definitionsByName_1_1.done; definitionsByName_1_1 = definitionsByName_1.next()) {
                    var _w = tslib.__read(definitionsByName_1_1.value, 2), definitionName = _w[0], definitions = _w[1];
                    ...
                    try {
                        for (var definitions_1 = (e_7 = void 0, tslib.__values(definitions)), definitions_1_1 = definitions_1.next(); !definitions_1_1.done; definitions_1_1 = definitions_1.next()) {
                    ...
                    if (dependenciesOfDefinition) {
                        try {
                            for (var dependenciesOfDefinition_1 = (e_8 = void 0, tslib.__values(dependenciesOfDefinition)), dependenciesOfDefinition_1_1 = dependenciesOfDefinition_1.next(); !dependenciesOfDefinition_1_1.done; dependenciesOfDefinition_1_1 = dependenciesOfDefinition_1.next()) {
                                ...
                                if (dependencyDefinitions != null) {
                                    try {
                                        for (var dependencyDefinitions_1 = (e_9 = void 0, tslib.__values(dependencyDefinitions)), dependencyDefinitions_1_1 = dependencyDefinitions_1.next(); !dependencyDefinitions_1_1.done; dependencyDefinitions_1_1 = dependencyDefinitions_1.next()) {
        ...
        try {
            for (var importLines_1 = tslib.__values(importLines), importLines_1_1 = importLines_1.next(); !importLines_1_1.done; importLines_1_1 = importLines_1.next()) {
                ...
                if (importFileDefinitionMap != null) {
                    if (imports.includes('*')) {
                        try {
                            for (var importFileDefinitionMap_1 = (e_11 = void 0, tslib.__values(importFileDefinitionMap)), importFileDefinitionMap_1_1 = importFileDefinitionMap_1.next(); !importFileDefinitionMap_1_1.done; importFileDefinitionMap_1_1 = importFileDefinitionMap_1.next()) {
                                var _y = tslib.__read(importFileDefinitionMap_1_1.value, 2), importedDefinitionName = _y[0], importedDefinitions = _y[1];
                                var _z = tslib.__read(importedDefinitionName.split('.'), 1), importedDefinitionTypeName = _z[0];
                                ...
                                if (allImportedDefinitions) {
                                    try {
                                        for (var importedDefinitions_1 = (e_12 = void 0, tslib.__values(importedDefinitions)), importedDefinitions_1_1 = importedDefinitions_1.next(); !importedDefinitions_1_1.done; importedDefinitions_1_1 = importedDefinitions_1.next()) {
                        ...
                        try {
                            for (var imports_1 = (e_13 = void 0, tslib.__values(imports)), imports_1_1 = imports_1.next(); !imports_1_1.done; imports_1_1 = imports_1.next()) {
                                ...
                                var _0 = tslib.__read(importedDefinitionName.split('.'), 1), importedDefinitionTypeName = _0[0];
                                if (!allImportedDefinitionsMap_1.has(importedDefinitionTypeName)) {
                                    allImportedDefinitionsMap_1.set(importedDefinitionTypeName, new Set());
                                }
                                var allImportedDefinitions = allImportedDefinitionsMap_1.get(importedDefinitionTypeName);
                                ...
                                if (allImportedDefinitions != null) {
                                    try {
                                        for (var importedDefinitions_2 = (e_14 = void 0, tslib.__values(importedDefinitions)), importedDefinitions_2_1 = importedDefinitions_2.next(); !importedDefinitions_2_1.done; importedDefinitions_2_1 = importedDefinitions_2.next()) {
            ...
            if (fileDefinitionMap_1) {
                ...
                var _loop_1 = function (definitionName) {
                    ...
                    if (definitionsWithDependencies) {
                        ...
                        if (dependenciesOfDefinition) {
                            try {
                                for (var dependenciesOfDefinition_2 = (e_17 = void 0, tslib.__values(dependenciesOfDefinition)), dependenciesOfDefinition_2_1 = dependenciesOfDefinition_2.next(); !dependenciesOfDefinition_2_1.done; dependenciesOfDefinition_2_1 = dependenciesOfDefinition_2.next()) {
                ...
                try {
                    for (var definitionsByName_2 = tslib.__values(definitionsByName), definitionsByName_2_1 = definitionsByName_2.next(); !definitionsByName_2_1.done; definitionsByName_2_1 = definitionsByName_2.next()) {
                        var _1 = tslib.__read(definitionsByName_2_1.value, 1), definitionName = _1[0];
...
function parseImportLine(importLine) {
    ...
    if (regexMatch != null) {
        ...
        var _a = tslib.__read(regexMatch, 5), wildcard = _a[1], importsString = _a[2], from = _a[4];
        if (from) {
    ...
    if (regexMatch != null) {
        var _b = tslib.__read(regexMatch, 3), from = _b[2];
        if (from) {
