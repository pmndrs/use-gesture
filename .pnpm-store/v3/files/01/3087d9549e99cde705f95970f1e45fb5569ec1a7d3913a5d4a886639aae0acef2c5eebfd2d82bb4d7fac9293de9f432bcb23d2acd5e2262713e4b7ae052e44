...
describe('github issue #165: Add support for `directives` in SDL', () => {
  it('should populate schema via `addTypeDefs()`', async () => {
    ...
    expect(Array.from(_.schemaComposer.types.keys())).toEqual(expect.arrayContaining(['String', 'Float', 'Int', 'Boolean', 'ID', 'MaybeNode', 'FakeNode', 'NonNode', 'NeverNode', 'Task', 'WayPoint', 'Route', 'RouteStep', 'ActorSubscribeInput', 'ActorNameChangeInput', 'ApplicationRequestDeleteAllInput', 'CommentCreateInput', 'CommentfeedbackFeedback', 'FeedbackcommentComment', 'CommentCreateSubscriptionInput', 'CommentDeleteInput', 'FeedbackLikeInput', 'NodeSaveStateInput', 'UpdateAllSeenStateInput', 'ActorSubscribeResponsePayload', 'ActorNameChangePayload', 'ApplicationRequestDeleteAllResponsePayload', 'CheckinSearchResult', 'CheckinSearchInput', 'PlainCommentBody', 'MarkdownCommentBody', 'CommentBody', 'Comment', 'CommentCreateResponsePayload', 'CommentDeleteResponsePayload', 'CommentsConnection', 'CommentsEdge', 'ConfigsConnection', 'ConfigsConnectionEdge', 'Config', 'Feedback', 'FeedbackLikeResponsePayload', 'FeedUnit', 'FriendsConnection', 'FriendsEdge', 'Image', 'LikersOfContentConnection', 'LikersEdge', 'Named', 'SimpleNamed', 'NewsFeedConnection', 'NewsFeedEdge', 'Node', 'Actor', 'NodeSavedStateResponsePayload', 'Page', 'PageInfo', 'PendingPostsConnection', 'PendingPostsConnectionEdge', 'PendingPost', 'Phone', 'PhoneNumber', 'Screenname', 'Segments', 'SegmentsEdge', 'NonNodeStory', 'PhotoStory', 'Story', 'StoryAttachment', 'StreetAddress', 'SubscribersConnection', 'SubscribersEdge', 'Text', 'TimezoneInfo', 'TopLevelCommentsConnection', 'UnfriendInput', 'UnfriendResponsePayload', 'JSDependency', 'HasJsField', 'PlainUserNameRenderer', 'PlainUserNameData', 'MarkdownUserNameRenderer', 'MarkdownUserNameData', 'CustomNameRenderer', 'UserNameRenderer', 'User', 'StorySearchInput', 'StoryCommentSearchInput', 'ItemFilterResult', 'ItemFilterInput', 'Viewer', 'MarketplaceExploreConnection', 'ViewerNotificationsUpdateAllSeenStateResponsePayload', 'Environment', 'MarketplaceBrowseContext', 'PhotoSize', 'PersonalityTraits', 'StoryType', 'TopLevelCommentsOrdering', 'Settings', 'Query', 'Mutation', 'Subscription']));
